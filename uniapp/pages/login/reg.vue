<template>
	<view class="content">
		...
		<view class="header">
			<image src="../../static/shilu-login/logo1.png"></image>
		</view>
		<view class="main">
			<wInput
				v-model="username"
			...
			<picker @change="bindPickerChange" :value="tishi" :range="array">
...
<style>
	...
	.header {
		...
		background:#ffffff;
		box-shadow:0upx 12upx 13upx 0upx rgba(204,4,10,0.47);
		border-radius:50%;
		margin-top: 20upx;
		margin-left: auto;
		margin-right: auto;
	...
	.yzm {
		...
		width:auto;
		height:64upx;
		border:1upx solid #rgba(63,205,235,1);
		border-radius: 50upx;
	}
	.yzms {
	...
	.dlbutton {
		...
		width:600upx;
		height:100upx;
		background:linear-gradient(-90deg,rgba(204,4,10,0.47),rgba(200,100,10,1));
...
/* 	.dlbutton-hover {
	...
	.sex{
		...
		font-size: 13.5px;
		font-weight: 800;
		/* background:linear-gradient(-19deg,rgba(0,0,0,0));		 */
		border-radius: 130px;
		border: none;
